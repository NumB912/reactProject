...
import CalendarDetailTour from "../../../component/calendar/tour/CalendarDetailTour";
    ...
    <div className="container py-10 m-10 justify-center flex flex-col items-center p-10">
      <div className="info w-full">
        ...
        <div className="grid grid-cols-10 gap-5">
          <div className="infodetail col-span-6 rounded flex-col flex gap-10">
            <div className="flex">
              <div className="overview font-bold p-3 border-b-2">Tổng quát</div>
              <div className="detail p-3">Chi tiết</div>
              <div className="literary p-3">Lịch trình</div>
              <div className="operator p-3">Mở rộng</div>
              <div className="reviews p-3">Reviews</div>
            </div>
            ...
            >
              <div className="flex flex-col justify-center gap-5">
                <div className="grid grid-cols-5 gap-5 w-full bg-gray-50 p-3 rounded">
                  <IconAndLabel
                ...
                <p className="text-md">
                  ...
                  thú, tham quan các hang động nổi tiếng, chèo kayak trên làn
                  nước trong xanh, tắm biển và tham gia nhiều hoạt động giải trí
                  hấp dẫn. Ngoài ra, du khách còn được thưởng thức các bữa tiệc
                  hải sản tươi ngon, tận hưởng hoàng hôn lãng mạn và đêm nhạc
                  sôi động trên boong tàu. Đây là lựa chọn lý tưởng để khám phá
                  trọn vẹn vẻ đẹp và sự quyến rũ của Vịnh Hạ Long.
                </p>
              </div>
            </CardContent>

            <CardContent
              title="Các mục cần chú ý"
              variant="outline"
              className="border-0"
            >
              <div className="grid grid-cols-5 gap-5 bg-gray-50 p-5">
                <IconAndLabel
                  Label="Đáng nhớ"
                  name="thumbs-up"
                  Direct="column"
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <div className="p-3">
                  <div className="flex gap-4">
                    ...
                    <div className="literary-detail mb-13">
                      ...
                      <p className="text-md">
                        ...
                        elit. Eius eligendi at esse, odit rem aut. Sint eos
                        natus facere totam aut recusandae odit nam incidunt
                        excepturi fugiat dolorem, exercitationem deserunt!
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    <div className="literary flex flex-col items-center justify-center">
                      <IconAndLabel
                        Label={<p className="font-bold">4</p>}
                        name="location-dot"
                        className="rounded bg-primary text-white p-2 gap-0 flex-wrap justify-center"
                        IconLayout="center"
                        LabelLayout="center"
                  ...
                  <div className="flex gap-4">
                    <div className="literary flex flex-col items-center justify-center">
                      <IconAndLabel
                        Label={<p className="font-bold">5</p>}
                        name="location-dot"
                        className="rounded bg-primary text-white p-2 gap-0 flex-wrap justify-center"
                        IconLayout="center"
                        LabelLayout="center"
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="literary-detail mb-13">
                      ...
                      <p className="text-md">
                        ...
                        elit. Eius eligendi at esse, odit rem aut. Sint eos
                        natus facere totam aut recusandae odit nam incidunt
                        excepturi fugiat dolorem, exercitationem deserunt! Lorem
                        ipsum dolor sit amet consectetur adipisicing elit. Quam
                        doloribus molestias illo eum, animi ullam cum delectus
                        esse tenetur eius possimus aperiam obcaecati, est
                        officiis natus debitis, quis corrupti! Maiores. Lorem
                        ipsum dolor sit amet consectetur adipisicing elit.
                        Eveniet animi in nostrum corrupti, est ullam
                        reprehenderit velit alias inventore voluptate iure fuga
                        harum rem soluta unde incidunt dolores sed neque?
                      </p>
                    </div>
                  </div>
                </div>
              </CardContentDropDown>
              <CardContentDropDown title="Thông tin thêm" variant="content">
              ...
              <CardContentDropDown title="Điểm khởi hành" variant="content">
                <div className="flex justify-start gap-3 h-full p-3">
              ...
              <CardContentDropDown title="Chính sách hủy" variant="content">
              ...
              <CardContentDropDown variant="content" title="Câu hỏi thường gặp">
                <div className="p-3">
                  <CardContentDropDown
                    title={
                      <p className="text-sm">Làm sao để có thể đặt được</p>
                    }
                    className="border-0"
                  >
                    <div className=" flex flex-col justify-start gap-3 h-full p-3">
                  ...
                  >
                    <div className=" flex flex-col justify-start gap-3 h-full p-3 text-sm">
                      Quý khách luôn có thể xem chi tiết đặt chỗ và truy xuất
                      chứng từ/thư xác nhận điện tử trên website hoặc ứng dụng
                      Agoda bằng cách đăng nhập và chọn "Đơn đặt chỗ của tôi" từ
                      menu tài khoản.
                    </div>
                  </CardContentDropDown>
                  ...
                  <CardContentDropDown
                    title={
                      <p className="text-sm">Chứng từ hoạt động như nào?</p>
                    }
                    className="border-0"
                  >
                    <div className=" flex flex-col justify-start gap-3 h-full p-3">
                      <p className="text-sm">
                        Quý khách sẽ nhận được chứng từ (hoặc tương đương) qua
                        thư điện tử. Hãy đưa chứng từ cho nhân viên tại điểm thu
                        vé hoặc cổng vào của điểm tham quan để họ có thể quét.
                        Mọi hướng dẫn cụ thể cho việc đặt vé của quý khách sẽ có
                        trong chứng từ.
                      </p>
                    </div>
                  </CardContentDropDown>
                  ...
                  <CardContentDropDown
                    title={
                      <p className="text-sm">Làm sao để có thể hủy đơn?</p>
                    }
                    className="border-0"
                  >
                    <div className=" flex flex-col justify-start gap-3 h-full p-3">
          ...
          <div className="col-span-4 shadow-lg h-fit p-5 sticky top-5 border border-gray-200">
            <div className="p-3 flex flex-col justify-center items-center">
              <p className="font-bold text-2xl w-full">
                Chọn ngày và số lượng khách
              </p>
              <div className="py-5 px-10 w-full max-w-md">
                <CalendarDetailTour />
              </div>
              <div className="time-ticker w-full flex flex-col gap-3">
                <p className="font-bold text-md">Chọn Thời gian</p>
                <div className="time-tour grid grid-cols-4 w-full gap-3">
