...
const Calendar_TwoMonth = ({
  ...
  let renderItemTwoMonth = (
    <CalendarWrap>
      ...
      <div className="flex w-full relative justify-center items-center border-b-2 gap-10 border-gray-300 max-md:flex-wrap">
      ...
      *:font-semibold *:rounded-full"
        ...
        <div className="right w-full">
          <div className="nameMonth w-full text-center p-2">
            {nextMonthDates[0]?.toLocaleString("vi-vn", { month: "short" }) +
              " " +
