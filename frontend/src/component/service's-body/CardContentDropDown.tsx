...
type VariantType = "primary" | "secondary" | "outline" | "content"
...
content: "bg-transparent border-0"
};
  ...
  return (
    ...
    >
      <div
        ...
        className={`flex justify-between items-center hover:bg-gray-100 w-full p-2 cursor-pointer ${internalOpen?"bg-gray-50":""} ${RoundedClasses[rounded]}`}
      >
