...
const EditProfileModal = ({isOpenEditProfileModal,setIsOpenEditProfileModal,userProfile}:EditProfileModalProp) => {
        ...
        >
          <div className="grid w-full p-5 gap-10 grid-cols-[100px_1fr] min-md:min-w-[800px] max-md:grid-cols-1 max-md:w-full max-md:gap-5">
            <div className="profile-edit-img w-full relative">
              ...
              >
                <img
                  src={photoImageAvatarTemp?photoImageAvatarTemp.url:photoImageAvatar?photoImageAvatar.url:`https://m.media-amazon.com/images/M/MV5BMzg3N2I3OTAtNThlYy00ZTM0LWFiMjItZmRkNzE3NWQ5MTg2XkEyXkFqcGdeQXRyYW5zY29kZS13b3JrZmxvdw@@._V1_QL75_UX500_CR0,0,500,281_.jpg`}
